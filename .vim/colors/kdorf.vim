...
hi CursorColumn                           ctermbg=235 guibg=#444444 cterm=none gui=none
hi FoldColumn   ctermfg=248 guifg=#a8a8a8 ctermbg=bg  guibg=bg
hi Folded       ctermfg=244 guifg=#808080 ctermbg=238 guibg=#444444
...
hi SpecialKey   ctermfg=248 guifg=#808080 ctermbg=235 guibg=#262626 cterm=bold gui=bold
...
hi TabLine      ctermfg=244 guifg=#808080 ctermbg=237 guibg=#3a3a3a cterm=none gui=none
hi TabLineFill  ctermfg=244 guifg=#808080 ctermbg=239 guibg=#4e4e4e cterm=none gui=none
