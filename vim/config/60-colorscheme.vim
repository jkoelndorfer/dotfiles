...
if !(expand('$TERM') == 'linux')
    ...
    hi NormalFloat ctermfg=NONE    ctermbg=8    guifg=NONE   guibg=NONE term=NONE gui=NONE
    hi FloatBorder ctermfg=10      ctermbg=10   guifg=None   guibg=NONE term=NONE gui=NONE
